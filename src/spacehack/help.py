...
_GUIDE_DUNGEON_EXTENSIONS = GuideSection(
    ...
    body=(
        ...
        "sealed, or ask your faction for a safe destination. The choice is "
        "recorded and changes the tone of later interpretations; it does not "
        "lock the final ending."
        "\n"
        "- Your faction needs time to compare the archive with its own records. "
        "The quest log shows Awaiting word while this minimum-wait gate is "
        "pending; spend that time on missions, trade, exploration, or upgrades. "
        "The summons has no deadline, and arriving late never fails the step."
        "\n"
