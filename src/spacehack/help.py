...
_GUIDE_GROUND_GEAR = GuideSection(
    ...
    body=(
        ...
        "pack slots"
        "\n"
        "- Buying opens an Install, Armory Storage, or Expedition Pack chooser"
        "before credits are deducted"
        "\n"
        "- Stored weapons and armor can be installed or sold from the armory"
        "with the compact action chooser; replacing gear preserves the old item"
        "\n"
