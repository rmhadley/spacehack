...
_GUIDE_CONTROLS = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- TAB: cycle targets (combat) or switch panels (loadout)"
        "\n"
...
_GUIDE_SHIPS = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- EMP Missile: 0 dmg (disables systems), 70% acc,"
        "2 AP, 2 ammo"
        "\n\n"
        "Modules:"
        "\n"
        "- Engines (compact/heavy reactor): bonus power"
        "generation"
        "\n"
        "- Systems: shield capacitors (+max shields), shield"
        "recharger (+regen), targeting computer (+gunnery),"
        "gyro stabilizer (+piloting), expanded cargo bays,"
        "armor plating (+hull, -power)"
        "\n\n"
