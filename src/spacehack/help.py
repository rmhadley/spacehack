...
_GUIDE_DUNGEON_EXTENSIONS = GuideSection(
    ...
    body=(
        ...
        "Post-prison orbit:"
        "\n"
        "- When you leave the prison by the Floor 1 < stairs (or return to "
        "the Mars port and launch), the archive wakes up in your communications "
        "array. It is not translated yet, but it appears "
        "to answer something."
        "\n"
