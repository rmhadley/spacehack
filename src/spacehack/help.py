...
_GUIDE_MISSIONS = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- Delivery T1 (Local): 5-10 cargo, 50-110$, same system or"
        "1 jump"
        "\n"
        "- Delivery T2 (Regional): 10-20 cargo, 160-320$, 1-2 jumps"
        "\n"
        "- Delivery T3 (Sector): 20-40 cargo, 420-840$, 2-4 jumps"
        "\n"
        "- Delivery T4 (Frontier): 40-60 cargo, 1030-1560$, 3-6 jumps"
        "\n"
