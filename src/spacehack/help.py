...
"- F: view faction standings"
        ...
        "Space mode:"
        "\n"
        "- G: pick up nearby loot when present; otherwise auto-nav (Go To) "
...
_GUIDE_DERELICT = GuideSection(
    ...
    body=(
        ...
        "y/u/b/n). Press G to collect loot on your tile or an adjacent "
        "cardinal tile. Loot is soft: it never blocks movement or enemy "
        "pathfinding. Exit the way you entered (the breach point marked "
        "with X)."
        "\n\n"
        "Loot:"
        "\n"
        "- Rooms may contain loot piles marked with $ on the floor. Press G "
        "to scavenge loot on your tile or an adjacent cardinal tile. Loot "
...
_GUIDE_GROUND_COMBAT = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- Press G while on or next to the loot pile to pick up trade goods "
