...
_GUIDE_MAIN_QUEST = GuideSection(
    ...
    body=(
        ...
        "\n"
        "The Bar chain — the Old Smuggler's route:"
        "\n"
        "- The Barkeep names the Old Smuggler on Barnard's Star b, "
        "who once cracked a door just like the one on Mars."
        "\n"
        "- To prove you're worth his time, the Barkeep hands you a "
        "hot crate of black-market weapons (a smuggling run — see "
        "Bar Missions) to deliver to the Old Smuggler."
        "\n"
        "- While you carry the crate, the militia is watching: the "
        "cargo-scan chance on every militia system gets a +30% "
        "floor while quest cargo is in your hold. Losing the crate "
        "to a scan (or abandoning it) resets the step — the Barkeep "
        "re-offers his last crate."
        "\n"
        "- The Old Smuggler draws you the cave where the old job "
        "went wrong. Descend the Barnard's Star b surface caves "
        "(delve) to recover the rig's power cell."
        "\n"
        "- The militia seals the gate: a quest-tagged militia patrol "
        "intercepts you in Barnard's Star (bounty objective). "
        "Fight it down, then return to Earth."
        "\n"
        "- The Barkeep assembles the brute-force rig — the tool that "
        "will crack the door's power feed. Collect it to finish the "
        "chain (the door itself stays sealed for now)."
        "\n\n"
        "Time gates:"
        "\n"
