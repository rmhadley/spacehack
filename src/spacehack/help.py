...
_GUIDE_GROUND_GEAR = GuideSection(
    ...
    body=(
        ...
        "\n\n"
        "Phase 1 equipment ownership:"
        "\n"
        "- Armory Storage is an unlimited global warehouse for owned gear"
        "\n"
        "- The Expedition Pack is a limited reserve: 4 base slots plus"
        "one slot per 10 Strength above 10"
        "\n"
        "- The backend preserves duplicate gear and old saves; the armory"
        "and dungeon controls arrive in later phases"
        "\n\n"
