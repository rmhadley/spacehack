...
_GUIDE_CHARACTER = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- Martian: +5 Piloting; ground +5 Reflexes"
        "\n\n"
        "Classes:"
        "\n"
        "- Pirate: +8 Gunnery; ground +8 Strength"
        "\n"
        "- Merchant: +8 Engineering; ground +8 Stamina"
        "\n"
        "- Bounty Hunter: +3 Gunnery, +3 Piloting, +3 Engineering; "
        "ground +3 all three stats"
        "\n\n"
...
_GUIDE_GROUND_COMBAT = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- Your HP = 20 + (STAMINA // 3), e.g. 30 HP at STA 30"
        "\n"
