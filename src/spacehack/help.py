...
_GUIDE_MISSIONS = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- Bounty (future): destroy a specific enemy in a target system."
        "\n\n"
        "Tiers (1-4):"
        "\n"
        "- Missions have a tier that controls cargo size, reward, and"
        "difficulty. Higher-tier planets offer higher-tier missions."
        "\n"
        "- Tier 1 (Local): 5-10 cargo, 50-100$, same system or 1 jump"
        "\n"
        "- Tier 2 (Regional): 10-20 cargo, 150-300$, 1-2 jumps"
        "\n"
        "- Tier 3 (Sector): 20-40 cargo, 400-800$, 2-4 jumps"
        "\n"
        "- Tier 4 (Frontier): 40-60 cargo, 1000-1500$, 3-6 jumps"
        "\n\n"
        ...
        "- On time: full pay."
        "\n"
        "- Late (past deadline): half credits, no XP. Still deliverable."
        "\n"
        ...
        "\n"
        "- Detail pane shows type, destination, cargo, reward, deadline."
        "\n"
