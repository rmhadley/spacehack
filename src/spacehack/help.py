...
_GUIDE_SHIPS = GuideSection(
    ...
    body=(
        ...
        "\n"
        "- FOR SALE view: left panel lists weapons and modules"
        "(sorted by price); ENTER buys the selected item"
        "\n"
        "- FOR SALE and STORAGE views: the right panel lists your installed"
        "weapon and module slots; ENTER stores the selected part"
        "without selling it"
        "\n"
        "- STORAGE view: left panel lists owned stored equipment; ENTER"
        "installs a selected compatible part"
        "\n"
        "- SELL view: ENTER sells the selected stored or installed part"
        "for a 50% refund"
        "\n"
        "- The view selector cycles FOR SALE -> STORAGE -> SELL"
        "\n"
        "- Cannot buy beyond your ship's slot limits"
        "\n\n"
        "Ship equipment storage:"
        "\n"
        "- The loadout window has three views: FOR SALE, STORAGE, and SELL"
        "\n"
        "- In FOR SALE, ENTER buys the selected weapon or module; on My Ship, "
        "ENTER stores installed equipment without selling it"
        "\n"
        "- STORAGE lists equipment you own but are not using; ENTER installs "
        "the selected part when a compatible slot is available"
        "\n"
        ...
        "\n"
        "- SELL is explicit: switch to that view when you intend to sell stored "
