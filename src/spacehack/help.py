...
_GUIDE_DUNGEON_EXTENSIONS = GuideSection(
    ...
    body=(
        ...
        "procedural floor: the entrance is torn open, claw scars cross the "
        "floor, and dark terminals sit in the empty chamber — only the "
        "single live terminal (T) responds"
        "\n"
