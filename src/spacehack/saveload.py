...
from .saveload_ground import (  # noqa: F401  # ground family split; re-exported
    _ground_fields,
...
def _identity_fields(ctx: GameContext) -> dict:
    ...
    return {
        ...
        "transponder_rig": bool(ctx.transponder_rig),
    }
...
def _parse_counters(data: dict):
    ...
    return PlayerCounters(
        ...
        merchant_missions_completed=pc.get("merchant_missions_completed", pc.get("deliveries_completed", 0)),
