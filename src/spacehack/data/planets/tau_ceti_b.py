...
SPEC = PlanetSpec(
    ...
    # mer_q3_transport / mer_q5_alloy / mer_q6_survey are live -- quest
    # NPCs are seated inside the merchants interior on entry
    ...
    dig_min_floors=2,
    dig_max_floors=4,
    dig_prefixes=('Brick', 'Grain', 'Steel', 'Plain', 'Working', 'Salt', 'Board', 'Common'),
    dig_suffixes=('Hall', 'Store', 'Yard', 'Works', 'Mill', 'Barn', 'Silo', 'Floor'),
)
