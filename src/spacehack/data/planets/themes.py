...
def derive_theme(
    ...
    **overrides,
    ...
    base = PlanetTheme(
        ...
        tree=T("tree", "T", _darken(grass, 0.78), _darken(grass, 0.32)),
        decor=T("plaza", "o", accent, _plaza_bg),
    )
    if overrides:
        return _replace(base, **overrides)
    return base
...
MARS = PlanetTheme(
    ...
    tree=T("tree", "T", (160, 100, 50), (50, 30, 15)),
    decor=T("plaza", "o", (255, 120, 60), (140, 100, 65)),
)
...
DESERT = PlanetTheme(
    ...
    tree=T("tree", "T", (130, 80, 40), (40, 22, 10)),
    decor=T("plaza", "o", (255, 100, 40), (120, 75, 50)),
)
...
LUSH = PlanetTheme(
    ...
    tree=T("tree", "T", (60, 200, 50), (35, 75, 30)),
    decor=T("plaza", "o", (255, 200, 80), (160, 140, 110)),
)
...
CLOUD_CITY = PlanetTheme(
    ...
    tree=T("tree", "T", (120, 200, 230), (50, 65, 85)),
    decor=T("plaza", "o", (200, 240, 255), (155, 175, 200)),
)
...
ICE = PlanetTheme(
    ...
    tree=T("tree", "T", (140, 210, 240), (70, 90, 120)),
    decor=T("plaza", "o", (200, 240, 255), (150, 175, 205)),
)
...
WARM_EARTH = PlanetTheme(
    ...
    tree=T("tree", "T", (160, 110, 50), (55, 38, 22)),
    decor=T("plaza", "o", (255, 150, 60), (145, 115, 80)),
)
