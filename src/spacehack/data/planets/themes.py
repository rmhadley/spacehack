...
def derive_theme(
    ...
    **overrides,
    ...
    base = PlanetTheme(
        ...
        # Accent bg matches the grass field's visible fg (full-bleed █), so
        # the comma reads as a subtle darker mark on the same field.
        grass_accent=T("grass", ",", _darken(grass, 0.75), grass),
...
MARS = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (140, 60, 35), (180, 80, 50)),
...
DESERT = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (110, 45, 30), (140, 60, 40)),
...
LUSH = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (70, 150, 55), (90, 180, 70)),
...
CLOUD_CITY = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (120, 170, 200), (140, 190, 220)),
...
ICE = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (180, 200, 230), (200, 220, 245)),
...
WARM_EARTH = PlanetTheme(
    ...
    grass_accent=T("grass", ",", (130, 90, 50), (150, 110, 60)),
