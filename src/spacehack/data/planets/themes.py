...
def derive_theme(
    ...
    **overrides,
    ...
    base = PlanetTheme(
        ...
        landing_pad=T("landing_pad", "O", _blend(grass, (150, 220, 255), 0.6), _darken(grass, 0.22)),
...
MARS = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (200, 130, 50), (50, 30, 15)),
...
DESERT = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (200, 120, 50), (40, 22, 10)),
...
LUSH = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (220, 200, 120), (55, 50, 30)),
...
CLOUD_CITY = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (200, 230, 255), (45, 60, 75)),
...
ICE = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (220, 240, 255), (50, 70, 95)),
...
WARM_EARTH = PlanetTheme(
    ...
    landing_pad=T("landing_pad", "O", (210, 160, 80), (45, 32, 18)),
