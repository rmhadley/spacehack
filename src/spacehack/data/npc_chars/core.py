...
NPC_CHARS: tuple[NpcCharSpec, ...] = (
    NpcCharSpec(
        ...
        char="E",
        fg=(120, 160, 220),      # consortium family blue (serious case)
        faction="consortium",
        hp=22,
    ...
    NpcCharSpec(
        ...
        char="e",
        fg=(120, 160, 220),      # consortium family blue (common case)
        faction="consortium",
        hp=28,
    ...
    NpcCharSpec(
        ...
        fg=(130, 230, 220),      # militia family teal (matches the fleet)
        faction="militia",
        hp=26,
