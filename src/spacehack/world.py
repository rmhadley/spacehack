...
WALL_TL = Tile(kind="wall", char="┏", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # top-left corner (heavy)
WALL_TR = Tile(kind="wall", char="┓", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # top-right corner (heavy)
WALL_BL = Tile(kind="wall", char="┗", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # bottom-left corner (heavy)
WALL_BR = Tile(kind="wall", char="┛", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # bottom-right corner (heavy)
WALL_H  = Tile(kind="wall", char="━", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # horizontal (heavy)
WALL_V  = Tile(kind="wall", char="┃", walkable=False, fg=(155, 185, 215), bg=(50, 62, 78))  # vertical (heavy)
