...
# bg matches GRASS's visible fg (the full-bleed block), so the comma
# reads as a subtle darker mark on the same light-green field.
GRASS_ACCENT = Tile(kind="grass", char=",", walkable=True, fg=(90, 175, 75), bg=(115, 200, 95))
