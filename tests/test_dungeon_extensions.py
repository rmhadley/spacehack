...
def test_deep_elevator_plays_the_descent_animation():
    """The F4->F5 elevator runs the wordless descent animation before
    travelling (doc 31 phase C, revised per user: motion, not prose)."""
