...
| 3 | **The ghost run** — REFRAMED (user): a gamble on hacking the ship's transponder. Every ship broadcasts an ID the Militia reads; the method is making yours invisible to the Line. Mechanics in design (below) | Frontier rumor; the outlaw-tech crowd | The hack (quality-priced) + surviving the physical net | The smuggler's hold hides cargo; the hack hides the ship — the full ghost kit |
